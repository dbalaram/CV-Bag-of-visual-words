...
load('/Users/dhanashreebalaram/Downloads/release/data/traintest.mat','train_imagenames','mapping');
load('dictionary.mat','filterBank','dictionary');

source = '/Users/dhanashreebalaram/Downloads/release/data/';
target = '/Users/dhanashreebalaram/Downloads/release/data/'; 
...
for i=1:3 %l
    ...
    save([target, strrep(train_imagenames{i},'.jpg','.mat')],'wordMap');
end
